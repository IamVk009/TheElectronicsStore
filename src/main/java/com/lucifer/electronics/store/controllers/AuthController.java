...
// Implementing Spring Security for Swagger using Annotation based approach
// Applying @SecurityRequirement annotation to API class to specify the security requirements for all the endpoints present in this class.
